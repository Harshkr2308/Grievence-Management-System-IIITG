      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" name="login" method="post" autocomplete="off">
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		            <input type="text" class="form-control" name="username"  autocomplete="off" placeholder="Email"  required autofocus>
		            <br>
...
<input type="password" class="form-control unicase-form-control text-input" placeholder="Confirm Password" id="confirmpassword" name="confirmpassword" required >
    ...
    <script>
        $.backstretch("https://leadtrekker.com/wp-content/uploads/2022/01/Customer-Complaint-Management-System.png", {speed: 500});
    </script>
