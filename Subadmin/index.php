...
$ret=mysqli_query($bd, "SELECT * FROM subadmin WHERE subadminEmail='$email' and password='$password'");
$num=mysqli_fetch_array($ret);
if($num>0)
{
$extra="change-password.php";//
$_SESSION['alogin']=$_POST['subadminEmail'];
$_SESSION['id']=$num['id'];
...
<head>
	...
	<title>GMS | SubAdmin login</title>
...
<body>
						...
						<div class="module-body">
							<div class="control-group">
								<div class="controls row-fluid">
									<input class="span12" type="text"  autocomplete="off" id="inputEmail" name="subadminEmail" placeholder="email">
								</div>
							</div>
							<div class="control-group">
								<div class="controls row-fluid">
						<input class="span12" type="password" id="inputPassword"  autocomplete="off" name="password" placeholder="Password">
								</div>
							</div>
						</div>
	...
	<div class="footer">
		<div class="container">
			...
			<b class="copyright">&copy; 2023 GMS </b> All rights reserved.
		</div>
	</div>
