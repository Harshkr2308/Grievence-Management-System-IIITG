...
{
$sql=mysqli_query($bd, "SELECT password FROM  subadmin where password='".md5($_POST['password'])."' && subadminName='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($bd, "update subadmin set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where subadminName='".$_SESSION['alogin']."'");
...
<head>
	...
	<title>subadmin| Change Password</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>subadmin Change Password</h3>
							</div>
