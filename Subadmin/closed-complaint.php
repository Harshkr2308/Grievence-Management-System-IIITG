...
<?php 
$st='closed';
$query=mysqli_query($bd, "select tblcomplaints.*,users.fullName as name from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.status='$st' AND forwardered=1 AND category=
...
?>								
										...
										<tr>
											...
											<td>   <a href="javascript:void(0);" onClick="popUpWindow('http://localhost/Complaint Management System/admin/view-feedback.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
											 View Feedback</a> 
											</td>
											</tr>
