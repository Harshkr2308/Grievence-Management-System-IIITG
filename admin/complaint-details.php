											...
											while ($row = mysqli_fetch_array($query)) {
												...
												while ($rw = mysqli_fetch_array($ret)) {
													...
													<tr>
														<td><b>Remark</b></td>
														<td colspan="5">
															<?php echo htmlentities($rw['remark']); ?> <b>Remark Date
												...
												<tr>
													...
													<td>
														...
														<td colspan="4">
															...
															<a href="javascript:void(0);"
																onClick="popUpWindow('http://localhost/Complaint Management System/admin/farwardpopup.php?cid=<?php echo htmlentities($row['complaintNumber']); ?>');"
																title="Update order">
																<button type="button" class="btn btn-primary">Forward to
																</button></a>
														</td>
														<td colspan="4">
															<a href="javascript:void(0);"
																onClick="popUpWindow('./admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']); ?>');"
																title="Update order">
													...
													<td colspan="4">
														<a href="javascript:void(0);"
															onClick="popUpWindow('http://localhost/Complaint Management System/admin/userprofile.php?uid=<?php echo htmlentities($row['userId']); ?>');"
															title="Update order">
